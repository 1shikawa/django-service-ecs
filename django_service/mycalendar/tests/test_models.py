...
class LargeItemTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        LargeItem.objects.create(name='large1')
    ...
    def test_LargeItem_label(self):
        ...
        self.assertEqual(LargeItem1_label, '大項目')
    ...
    def test_LargeItem_value(self):
        ...
        self.assertEqual(LargeItem1_value, 'large1')
...
class MiddleItemTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        LargeItem.objects.create(name='large1')
        MiddleItem.objects.create(name='middle1', parent_id='1')
    ...
    def test_MiddleItem_label(self):
        ...
        self.assertEqual(MiddleItem1_label, '中項目')
    ...
    def test_MiddleItem_value(self):
        ...
        self.assertEqual(MiddleItem1_value, 'middle1')
...
class ScheduleModelTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        LargeItem.objects.create(name='large1')
        MiddleItem.objects.create(name='middle1', parent_id='1')
        Schedule.objects.create(LargeItem_id='1', MiddleItem_id='1', SmallItem='small1', kosu='99', totalkosu='99',
    ...
    def test_Schedule_value_SmallItem(self):
        ...
        self.assertEqual(schedule1_value_SmallItem, 'small1')
